(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).find('.ays_add_answer').live('click', function () {
            ...
            $(this).parents().eq(1).before('<tr><td><input class="ays_answer_unique_id" type="radio" name="ays_answer_radio[' + (++question_id) + ']"></td><td class="ays_answer_td"><input type="text" placeholder="Empty Answer" class="ays_answer"></td><td class="active_remove_answer"><i class="ays_fa ays_fa_times" aria-hidden="true"></i></td></tr>');
        });
