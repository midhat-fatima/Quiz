...
<div class="tve-icons-wrapper">
	<div id="tve-icomoon-icons" class="tve-icons-list">
		<?php if ( ! empty( $icon_data['icons'] ) ) { ?>
			<h4 class="tve-icons-header tve-custom-header set-toggle set-icomoon"><?php echo __( 'Custom Icons', 'thrive-cb' ) ?></h4>
		<?php } ?>
		<div class="tve-custom-icons set-icomoon set-toggle">
		...
		<h4 class="tve-icons-header set-fontawesome set-toggle"><?php echo __( 'Font Awesome Icons', 'thrive-cb' ) ?></h4>
		<div class="tve-font-awesome-icons set-fontawesome set-toggle"></div>
	</div>
</div>
