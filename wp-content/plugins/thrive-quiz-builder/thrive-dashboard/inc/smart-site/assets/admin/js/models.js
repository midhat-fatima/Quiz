( function ( $ ) {
	...
	models.Field = models.Base.extend( {
		...
		validateAddressField: function ( data ) {
			...
			if ( ! data.city ) {
				this.errors.push( this.validation_error( 'data_city', SmartSite.t.InvalidCity ) );
			}

			if ( ! data.country ) {
				this.errors.push( this.validation_error( 'data_country', SmartSite.t.InvalidCountry ) );
			}

			if ( ! data.zip ) {
				this.errors.push( this.validation_error( 'data_zip', SmartSite.t.InvalidZip ) );
			}
		},
