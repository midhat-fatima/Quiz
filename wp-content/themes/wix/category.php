...
*/ 
get_header(); 
$wix_archives = get_the_category();
$wix_archives_name = $wix_archives[0]->name;
$wix_archives_id = $wix_archives[0]->cat_ID; ?>
<!-- Details Start  -->
    	...
    	<div class="row details-mian">
            ...
            <article class="col-md-8">
                ...
                <div class="col-md-12 wix-page-title">
        			<h1><?php echo 'Category : <a>'.$wix_archives[0]->name.'</a>'; ?></h1>
				</div>
